    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4">
      <div className="w-full max-w-4xl">
        <div className="text-center mb-8 sm:mb-12">
          <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2 sm:mb-3">TekodakService</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          ...
          >
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-white">Admin Portal</h2>
            </div>
          </button>
          ...
          >
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-white">Personel Portalı</h2>
            </div>
          </button>
        </div>
      </div>
